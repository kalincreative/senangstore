...
export async function updateSession(request: NextRequest) {
  ...
  // mistake can make it very hard to debug issues with sessions being lost.
  ...
  // If this is not done, you may be causing the browser and server to go out of sync and terminate the user's session.
