  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 mx-auto py-12">
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-[#111c2d]">Start Your Store</h1>
        <p className="text-sm text-[#3d4947]">Build your digital storefront in minutes</p>
      </div>
      ...
      <form className="flex-1 flex flex-col w-full justify-center gap-4 animate-in">
        ...
        <div className="relative my-4">
          ...
          <div className="relative flex justify-center text-xs uppercase">
            <span className="bg-[#f9f9ff] px-2 text-[#6d7a77]">Or sign up with</span>
          </div>
        </div>
      ...
      <p className="text-center text-sm text-[#6d7a77] mt-8">
        ...
        <Link href="/login" className="text-[#00685f] font-semibold hover:underline">
          Sign in here
        </Link>
      </p>
    </div>
